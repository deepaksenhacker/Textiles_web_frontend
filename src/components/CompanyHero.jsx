    ...
    return (
        ...
        <div className='w-full p-2  '>
            <div className="w-full p-2 flex flex-col gap-10  bg-gradient-to-t  ">
                ...
                {/* main */}
                <div className="w-full border-b-8 mb-4 p-3">
                    {/* container */}
                    <div className="flex gap-4 mb-4">
                        ...
                        <div className="flex w-full gap-3">
                            <video src="/video/video2.mp4" autoPlay loop className=' rounded-3xl w-[15rem]  object-cover border-2 '>

                            </video>
                            <video src="/video/video3.mp4" autoPlay loop className=' rounded-3xl w-[33rem]  object-cover border-2 '>
